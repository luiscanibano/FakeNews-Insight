      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {content.plans.map((plan, index) => (
            ...
            >
              {plan.recommended && (
                <div className="absolute -top-4 left-1/2 z-10 -translate-x-1/2 whitespace-nowrap rounded-full bg-primary px-4 py-1 text-[10px] font-bold uppercase tracking-widest text-on-primary shadow-lg shadow-primary/30">
