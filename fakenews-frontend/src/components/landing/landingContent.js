export const landingContent = {
  ...
  features: {
    ...
    primaryFeature: {
      ...
      description:
        "Pega un texto o la URL de una noticia y nuestro modelo predictivo te devolverá un porcentaje de fiabilidad en milisegundos. Utilizamos modelos de lenguaje entrenados en millones de artículos verificados.",
