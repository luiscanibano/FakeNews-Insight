  ...
  return (
    <section className="bg-surface-container-lowest px-6 py-24">
      <div className="mx-auto w-full max-w-7xl">
        <Card className="landing-glass-card landing-reveal ring-0 relative overflow-hidden rounded-[2rem] border border-outline-variant/15 bg-surface-container p-12">
