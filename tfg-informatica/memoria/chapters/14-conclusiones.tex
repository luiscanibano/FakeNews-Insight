...
\begin{enumerate}[leftmargin=*,itemsep=0.2em]
  ...
  \item La integración de un clasificador NLI DeBERTa-v3-small
        entrenado sobre FEVER-NLI, exportado a ONNX y conectado al
        agente de verificación del backend.
...
\begin{itemize}[leftmargin=*,itemsep=0.2em]
  ...
  \item Añadir soporte multilenguaje real al modelo (modelos NLI
        multilingües).
  \item Calibrar \emph{post-hoc} las probabilidades del clasificador
        NLI antes de utilizarlas como probabilidades operativas.
