...
\begin{enumerate}[leftmargin=*,itemsep=0.2em]
  ...
  \item Implementar y evaluar un \textbf{baseline} basado en
        ...
        regularización $\ell_2$, sobre una partición de prueba
        estratificada y diagnóstico de calibración.
  ...
  \item Diagnosticar la \textbf{calibración} de las probabilidades del
        clasificador mediante NLL, Brier, ECE y diagramas de fiabilidad.
...
capítulo~\ref{cap:calibracion} aborda el diagnóstico de calibración. El
