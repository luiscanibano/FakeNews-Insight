...
\begin{enumerate}[leftmargin=*,itemsep=0.2em]
  \item Para $b = 1, \dots, B$ con $B = 1\,000$:
        \begin{enumerate}
...
\begin{table}[h]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
    DeBERTa vs.\ TF-IDF+LR & 1532.2167 & $<10^{-300}$ & $[\,0.2289,\;0.2503\,]$ \\
    \bottomrule
  \end{tabular}
  \caption{Contrastes estadísticos pareados sobre la partición de prueba.}
  \label{tab:tests}
\end{table}

La tabla de discordancias fue
$\begin{psmallmatrix}4551 & 2603 \\ 442 & 2230\end{psmallmatrix}$,
donde DeBERTa acierta 2603 ejemplos que el baseline falla, frente a
442 casos en sentido contrario. El p-valor queda por debajo de la
precisión numérica de doble precisión y se reporta como menor que
$10^{-300}$. El intervalo bootstrap para la diferencia de F1 macro no
contiene cero, por lo que la mejora observada no es atribuible a ruido
de muestreo.
