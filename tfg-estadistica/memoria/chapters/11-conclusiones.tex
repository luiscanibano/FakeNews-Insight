...
\begin{enumerate}[leftmargin=*,itemsep=0.3em]
  ...
  \item El \emph{fine-tuning} y comparación de DeBERTa-v3-base como
        modelo de referencia neuronal (capítulo~\ref{cap:deberta}).
  \item La aplicación sistemática de calibración \emph{post-hoc}
        (capítulo~\ref{cap:calibracion}), garantizando que las
        probabilidades emitidas tengan interpretación frecuentista.
